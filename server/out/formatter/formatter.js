    ...
    formatNode(node) {
        switch (node.type) {
            case 'function':
                ...
                break;
            case 'struct':
                this.formatStruct(node);
                break;
            case 'enum':
                this.formatEnum(node);
                break;
            case 'variable':
                this.formatVariable(node);
                break;
            case 'statement':
                this.formatStatement(node);
                break;
        }
    }
    formatFunction(func) {
